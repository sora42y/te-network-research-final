...
\paragraph{On nonparametric TE.} We also tested KNN-based nonparametric TE
estimators. They perform worse than linear methods at all $T/N < 10$,
achieving near-random precision (6--13\%). See Appendix~\ref{app:nonparametric}
for details. Linear methods, while theoretically limited, are the only
computationally feasible option at financial sample sizes.
